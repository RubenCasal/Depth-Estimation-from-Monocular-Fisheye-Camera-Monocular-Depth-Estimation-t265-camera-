...
class DepthEstimatorNode(Node):
    ...
    def image_callback(self, msg):
        try:
            ...
            if self.counter == 4:
                self.depth_estimator.save_colored_ply(xyz, rgb)
            """
...
#Visualize Meash pointcloud
# env -i DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY HOME=$HOME meshlab colored_pointcloud.ply
